...
# you may wnt to work with simple variables. 

# theere are 4 functions that may be used to input data
...
# and ending at 0 in going in steps of 3
x2 <- seq(
    30, # starting value
    0, # ending value
    by = -3 # step
...
# the concatenate function can ued to combine or collect
# data values
...
# the replication function can be used to replicate data values.
