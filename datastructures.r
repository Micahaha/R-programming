...
# the data value put into a vector must be of the 
# the same data.
# a vector may consist of 1 elements or multiple
# elements
...
# the data values must be of the same data type.
# use the array functions to create arrays.
...
# use the as.data.frame and cbind funtions to create
# a data frame
df <- as.data.frame(cbind(vnumeric,vcharacter,vlogical))
df

# the list is one of he most robust and flexible data
