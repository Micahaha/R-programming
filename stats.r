...
# second arg. specifies taht the first row of the
# text file contains the names of the variabls
...
# use table function to create a frequency table 
...
# use the mean function to calculate the mean for a quantitative 
# variable
...
# use the median function to calculate the mean for a
...
# may provide 1 specific quantile or multiple quantities
